...
public class AutomationPracticeForm extends TestBase {
    ...
    void firstTest() {
        ...
        practiceFormPage.setFirstName("Kir");
        practiceFormPage.setLastName("Morozov");
        practiceFormPage.setUserEmail("morozovk18@mail.ru");
        practiceFormPage.setGender("Male");
        practiceFormPage.setUserNumber("88003555555");
